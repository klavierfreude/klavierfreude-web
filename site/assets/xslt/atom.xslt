...
<xsl:template match="/atom:feed">
	...
	<meta name="description" content="Home page of the Verein Klavierfreude Wien">
	...
	<link rel="icon" sizes="32x32" href="https://klavierfreude.at/assets/img/favicon-32x32.png">

	<link rel="icon" sizes="192x192" href="https://klavierfreude.at/assets/img/touch-icon-192x192.png">

	<link rel="apple-touch-icon-precomposed" sizes="180x180" href="https://klavierfreude.at/assets/img/apple-touch-icon-180x180-precomposed.png">

	<link rel="apple-touch-icon-precomposed" sizes="152x152" href="https://klavierfreude.at/assets/img/apple-touch-icon-152x152-precomposed.png">

	<link rel="apple-touch-icon-precomposed" sizes="144x144" href="https://klavierfreude.at/assets/img/apple-touch-icon-144x144-precomposed.png">

	<link rel="apple-touch-icon-precomposed" sizes="120x120" href="https://klavierfreude.at/assets/img/apple-touch-icon-120x120-precomposed.png">

	<link rel="apple-touch-icon-precomposed" sizes="114x114" href="https://klavierfreude.at/assets/img/apple-touch-icon-114x114-precomposed.png">

	
	<link rel="apple-touch-icon-precomposed" sizes="76x76" href="https://klavierfreude.at/assets/img/apple-touch-icon-76x76-precomposed.png">

	<link rel="apple-touch-icon-precomposed" sizes="72x72" href="https://klavierfreude.at/assets/img/apple-touch-icon-72x72-precomposed.png">

	<link rel="apple-touch-icon-precomposed" href="https://klavierfreude.at/assets/img/apple-touch-icon-precomposed.png">	

	<meta name="msapplication-TileImage" content="https://klavierfreude.at/assets/img/msapplication_tileimage.png">
...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar data-options="scrolltop: false">
    <ul class="title-area">
      <li class="name">
      <h1 class="hide-for-large-up"><a href="https://klavierfreude.at" class="icon-tree"> Verein Klavierfreude Wien</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="right">
              ...
              <li class="divider"></li>
              <li><a  href="https://klavierfreude.at/search/">Search</a></li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="https://klavierfreude.at/" title="Verein Klavierfreude Wien – [SLOGAN]">
				<img src="https://klavierfreude.at/assets/img/logo.png" alt="Verein Klavierfreude Wien – [SLOGAN]">
			</a>
